                          ...
                          <?php
                            ...
                            foreach ($karyawan as $key => $value) {
                              ...
                              foreach ($kriteria as $key_sub => $value_sub) {
                                $form_sub .= '
                                  <td>
                                      <input required="" value="0.5" type="number" name="id_kriteria_'.$value->id_user.'['.$value_sub->id_kriteria.']" placeholder="0.1 s.d 1" step="0.01" min="0.1" max="1" class="form-control" >
                                  </td>
                                ';
                              }
                              echo '
