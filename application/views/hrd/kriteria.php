        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="<?php echo base_url( $this->session->userdata('level') ) ?>/form-kriteria" class="btn btn-default float-right form-load" title="Tambah Informasi Kriteria"><i class="fa fa-plus"></i> Add New</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
